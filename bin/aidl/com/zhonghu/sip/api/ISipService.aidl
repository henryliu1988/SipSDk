...
interface ISipService{
	...
	*/ 
	 ...
	 */
	void makeCall(in String callee,long id);
	 ...
	 */
	void makeCallWithOptions(in String callee,long id);
	...
	void setVolume(in SipCallSession callInfo,int value);
	...
	*/
	 ...
	 */ 
	  ...
	  */
	  void setConfigParam(String key,String value);
