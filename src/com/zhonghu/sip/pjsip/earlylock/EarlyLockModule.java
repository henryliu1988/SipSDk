...
package com.zhonghu.sip.pjsip.earlylock;
...
import com.zhonghu.sip.pjsip.PjSipService.PjsipModule;
...
public class EarlyLockModule implements PjsipModule {
     ...
     * (non-Javadoc)
     * @see
     * com.zhonghu.sip.pjsip.PjSipService.PjsipModule#setContext(android.content
     * .Context)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.zhsip.pjsip.PjSipService.PjsipModule#onBeforeStartPjsip()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.zhsip.pjsip.PjSipService.PjsipModule#
     * onBeforeAccountStartRegistration(int, com.zhsip.api.SipProfile)
     */
    @Override
    ...
    private class WorkLocker extends Thread {
        ...
        WorkLocker(long time) {
            lockTime = time;
            wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.zhsip.earlylock");
            wl.acquire();
        }
