...
public class SipProfileState implements Parcelable, Serializable{
	...
	public final void updateFromContentValue(ContentValues args) {
		Integer tmp_i;
		String tmp_s;
		Boolean tmp_b;
	...
	public String toString() {
		return "SipProfileState [primaryKey=" + primaryKey + ", id="
				+ id + ", pjsuaId=" + pjsuaId + ", wizard=" + wizard
