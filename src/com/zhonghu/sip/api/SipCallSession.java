...
public class SipCallSession implements Parcelable {
	...
	public String toString() {
		return "SipCallSession [primaryKey=" + primaryKey + ", callStart="
				+ callStart + ", callId=" + callId + ", callState=" + callState
				+ ", remoteContact=" + remoteContact + ", isIncoming="
				+ isIncoming + ", confPort=" + confPort + ", accId=" + accId
				+ ", mediaStatus=" + mediaStatus + ", mediaSecure="
				+ mediaSecure + ", transportSecure=" + transportSecure
				+ ", mediaHasVideoStream=" + mediaHasVideoStream
				+ ", connectStart=" + connectStart + ", lastStatusCode="
				+ lastStatusCode + ", lastStatusComment=" + lastStatusComment
				+ ", lastReasonCode=" + lastReasonCode + ", mediaSecureInfo="
				+ mediaSecureInfo + ", canRecord=" + canRecord
				+ ", isRecording=" + isRecording + ", zrtpSASVerified="
				+ zrtpSASVerified + ", hasZrtp=" + hasZrtp + "]";
	}
