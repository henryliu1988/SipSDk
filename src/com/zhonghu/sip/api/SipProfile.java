...
import com.zhonghu.sip.api.SipUri.ParsedSipUriInfos;
...
public class SipProfile implements Parcelable {
	 ...
	 */
	public final static String ACCOUNT_CONTENT_TYPE = SipManager.BASE_DIR_TYPE
			+ ".account";
	/**
	 * Item type for account / sip profile
	 */
	public final static String ACCOUNT_CONTENT_ITEM_TYPE = SipManager.BASE_ITEM_TYPE
			+ ".account";
	// /**
	// * Uri of accounts / sip profiles
	// */
	// public final static Uri ACCOUNT_URI = Uri
	...
	// */
	// public final static Uri ACCOUNT_ID_URI_BASE = Uri
	// .parse(ContentResolver.SCHEME_CONTENT + "://"
	// + SipManager.AUTHORITY + "/" + ACCOUNTS_TABLE_NAME + "/");
	//
	...
	// */
	// public final static String ACCOUNTS_STATUS_TABLE_NAME =
	// "accounts_status";
	// /**
	...
	// */
	// public final static Uri ACCOUNT_STATUS_URI = Uri
	// .parse(ContentResolver.SCHEME_CONTENT + "://"
	...
	// * @see ContentUris#appendId(android.net.Uri.Builder, long)
	// */
	// public final static Uri ACCOUNT_STATUS_ID_URI_BASE = Uri
	// .parse(ContentResolver.SCHEME_CONTENT + "://"
	// + SipManager.AUTHORITY + "/" + ACCOUNTS_STATUS_TABLE_NAME
	// + "/");
	...
	public void updateProfileFromValues(ContentValues args) {
	 ...
	 * 
	 * @param ctxt
	 *            Your application context. Mainly useful to get the content
	 *            provider for the request.
	 * @param accountId
	 *            The sip profile {@link #FIELD_ID} you want to retrieve.
	 * @param projection
	 *            The list of fields you want to retrieve. Must be in FIELD_* of
	 *            this class.<br/>
	 *            Reducing your requested fields to minimum will improve speed
	 *            of the request.
	 * @return A wrapper SipProfile object on the request you done. If not found
	 *         an invalid account with an {@link #id} equals to
	 *         {@link #INVALID_ID}
	 */
	// public static SipProfile getProfileFromDbId(Context ctxt, long accountId,
	// String[] projection) {
	 ...
	 *            provider for the request.
	 * @param onlyActive
	 *            Pass it to true if you are only interested in active accounts.
	 * @return The list of SipProfiles containings only fields of
	 *         {@link #LISTABLE_PROJECTION} filled.
	 * @see #LISTABLE_PROJECTION
	 */
	// public static ArrayList<SipProfile> getAllProfiles(Context ctxt,
	// boolean onlyActive) {
	 ...
	 */
	// public static ArrayList<SipProfile> getAllProfiles(Context ctxt,
	// boolean onlyActive, String[] projection) {
	...
	// }
	// Cursor c = ctxt.getContentResolver().query(ACCOUNT_URI, projection,
	...
	public String toString() {
		return "SipProfile [primaryKey=" + primaryKey + ", id=" + id
				+ ", display_name=" + display_name + ", wizard=" + wizard
				+ ", transport=" + transport + ", default_uri_scheme="
				+ default_uri_scheme + ", active=" + active + ", priority="
				+ priority + ", acc_id=" + acc_id + ", reg_uri=" + reg_uri
				...
				+ ", ipv6_media_use=" + ipv6_media_use + ", wizard_data="
				+ wizard_data + "]";
	}
	...
	public boolean isAllow_sdp_nat_rewrite() {
		return allow_sdp_nat_rewrite;
	}

	public void setAllow_sdp_nat_rewrite(boolean allow_sdp_nat_rewrite) {
		this.allow_sdp_nat_rewrite = allow_sdp_nat_rewrite;
	}
