 ...
 * Original file: E:\\400\\企业通讯项目\\Android\\Code\\versionSDK\\SipSDk\\src\\com\\zhonghu\\sip\\api\\ISipConfiguration.aidl
 */
package com.zhonghu.sip.api;
public interface ISipConfiguration extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.zhonghu.sip.api.ISipConfiguration
{
private static final java.lang.String DESCRIPTOR = "com.zhonghu.sip.api.ISipConfiguration";
...
/**
 * Cast an IBinder object into an com.zhonghu.sip.api.ISipConfiguration interface,
 * generating a proxy if needed.
 */
public static com.zhonghu.sip.api.ISipConfiguration asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.zhonghu.sip.api.ISipConfiguration))) {
return ((com.zhonghu.sip.api.ISipConfiguration)iin);
}
return new com.zhonghu.sip.api.ISipConfiguration.Stub.Proxy(obj);
}
...
private static class Proxy implements com.zhonghu.sip.api.ISipConfiguration
{
