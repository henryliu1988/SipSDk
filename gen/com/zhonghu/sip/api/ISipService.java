 ...
 * Original file: E:\\400\\企业通讯项目\\Android\\Code\\versionSDK\\SipSDk\\src\\com\\zhonghu\\sip\\api\\ISipService.aidl
 */
package com.zhonghu.sip.api;
public interface ISipService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.zhonghu.sip.api.ISipService
{
private static final java.lang.String DESCRIPTOR = "com.zhonghu.sip.api.ISipService";
...
/**
 * Cast an IBinder object into an com.zhonghu.sip.api.ISipService interface,
 * generating a proxy if needed.
 */
public static com.zhonghu.sip.api.ISipService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.zhonghu.sip.api.ISipService))) {
return ((com.zhonghu.sip.api.ISipService)iin);
}
return new com.zhonghu.sip.api.ISipService.Stub.Proxy(obj);
}
...
int _arg0;
_arg0 = data.readInt();
com.zhonghu.sip.api.SipProfileState _result = this.getSipProfileState(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
long _arg1;
_arg1 = data.readLong();
this.makeCallWithOptions(_arg0, _arg1);
reply.writeNoException();
return true;
}
...
int _arg0;
_arg0 = data.readInt();
com.zhonghu.sip.api.SipCallSession _result = this.getCallInfo(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
com.zhonghu.sip.api.SipCallSession[] _result = this.getCalls();
reply.writeNoException();
...
{
data.enforceInterface(DESCRIPTOR);
com.zhonghu.sip.api.SipCallSession _arg0;
if ((0!=data.readInt())) {
_arg0 = com.zhonghu.sip.api.SipCallSession.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
com.zhonghu.sip.api.MediaState _result = this.getCurrentMediaState();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
com.zhonghu.sip.api.ICallback _arg0;
_arg0 = com.zhonghu.sip.api.ICallback.Stub.asInterface(data.readStrongBinder());
...
case TRANSACTION_setConfigParam:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
java.lang.String _arg1;
_arg1 = data.readString();
this.setConfigParam(_arg0, _arg1);
reply.writeNoException();
return true;
}
case TRANSACTION_getConfigParam:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
java.lang.String _result = this.getConfigParam(_arg0);
reply.writeNoException();
reply.writeString(_result);
return true;
}
...
private static class Proxy implements com.zhonghu.sip.api.ISipService
{
...
/**
	...
	*/
@Override public com.zhonghu.sip.api.SipProfileState getSipProfileState(int accountId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.zhonghu.sip.api.SipProfileState _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(accountId);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.zhonghu.sip.api.SipProfileState.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
/**
	 ...
	 */
@Override public void makeCall(java.lang.String callee, long id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	 ...
	 */
@Override public void makeCallWithOptions(java.lang.String callee, long id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public com.zhonghu.sip.api.SipCallSession getCallInfo(int callId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.zhonghu.sip.api.SipCallSession _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(callId);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.zhonghu.sip.api.SipCallSession.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.zhonghu.sip.api.SipCallSession[] getCalls() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.zhonghu.sip.api.SipCallSession[] _result;
...
_reply.readException();
_result = _reply.createTypedArray(com.zhonghu.sip.api.SipCallSession.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public void adjustVolume(com.zhonghu.sip.api.SipCallSession callInfo, int direction, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void setVolume(com.zhonghu.sip.api.SipCallSession callInfo, int value) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public com.zhonghu.sip.api.MediaState getCurrentMediaState() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.zhonghu.sip.api.MediaState _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurrentMediaState, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.zhonghu.sip.api.MediaState.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
/**
	 * registerCallback
	 */
@Override public void registerCallback(com.zhonghu.sip.api.ICallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	 *unregisterCallback
	 */
@Override public void unregisterCallback(com.zhonghu.sip.api.ICallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	  * set Config Params for SipService
	  */
@Override public void setConfigParam(java.lang.String key, java.lang.String value) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setConfigParam, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
/**
	  * get Config Params for SipService
	  */
@Override public java.lang.String getConfigParam(java.lang.String key) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.lang.String _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(key);
mRemote.transact(Stub.TRANSACTION_getConfigParam, _data, _reply, 0);
_reply.readException();
_result = _reply.readString();
}
finally {
...
static final int TRANSACTION_getCurrentMediaState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_startLoopbackTest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_stopLoopbackTest = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_startRecording = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_stopRecording = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_isRecording = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_canRecord = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_playWaveFile = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_sendMessage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
...
static final int TRANSACTION_registerCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_unregisterCallback = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_setConfigParam = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_getConfigParam = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
}
/**
	* Get the current API version
	* @return version number. 1000 x major version + minor version
...
/**
	...
	* @return the Profile state
	*/
public com.zhonghu.sip.api.SipProfileState getSipProfileState(int accountId) throws android.os.RemoteException;
//Call configuration control
/**
	 * Switch next incoming request to auto answer
	 */
...
/**
	 ...
	 * @param accountId The id of the account to use for this call. 
	 */
public void makeCall(java.lang.String callee, long id) throws android.os.RemoteException;
/**
	 * Place a call.
	 * 
	 * @param callee The sip uri to call. 
	 ...
	 * @param options The options you'd like to apply for this calls {@link SipCallSession#OPT_CALL_VIDEO}, {@link SipCallSession#OPT_CALL_EXTRA_HEADERS}
	 */
public void makeCallWithOptions(java.lang.String callee, long id) throws android.os.RemoteException;
/**
	 * Answer a call.
	 * 
	 * @param callId The id of the call to answer.
...
public com.zhonghu.sip.api.SipCallSession getCallInfo(int callId) throws android.os.RemoteException;
public com.zhonghu.sip.api.SipCallSession[] getCalls() throws android.os.RemoteException;
...
public void adjustVolume(com.zhonghu.sip.api.SipCallSession callInfo, int direction, int flags) throws android.os.RemoteException;
public void setVolume(com.zhonghu.sip.api.SipCallSession callInfo, int value) throws android.os.RemoteException;
public com.zhonghu.sip.api.MediaState getCurrentMediaState() throws android.os.RemoteException;
...
/**
	 * registerCallback
	 */
public void registerCallback(com.zhonghu.sip.api.ICallback cb) throws android.os.RemoteException;
/**
	 *unregisterCallback
	 */
public void unregisterCallback(com.zhonghu.sip.api.ICallback cb) throws android.os.RemoteException;
/**
	  * set Config Params for SipService
	  */
public void setConfigParam(java.lang.String key, java.lang.String value) throws android.os.RemoteException;
/**
	  * get Config Params for SipService
	  */
public java.lang.String getConfigParam(java.lang.String key) throws android.os.RemoteException;
}
